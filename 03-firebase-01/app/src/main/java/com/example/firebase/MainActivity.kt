...
class MainActivity : AppCompatActivity() {
    ...
    val mensajeNoLogueado = "Dale click al botón ingresar"
    ...
    fun pedidoIngresar() {
        ...
        startActivityForResult(
            AuthUI.getInstance()
                ...
                .setLogo(R.drawable.imagen_selected)
    ...
    fun cargarRolesUsuario(uid: String){
        ...
        referencia
                ...
                .addOnFailureListener{
                    Log.i("firebase-firestore","fallo la carga de usuario")
                }
    }
